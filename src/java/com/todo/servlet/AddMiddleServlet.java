 ...
 * @author Windows
 */
public class AddMiddleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddMiddleServlet</title>");            
            out.println("</head>");
            out.println("<body>");
         
            String listno=request.getParameter("listnumber");
            int listlocation=Integer.parseInt(request.getParameter("listlocation"));
