                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card" style="margin-top:30px;">
                            <div class="card-header" style="font-size:20px"><center><b>Enter the Number to delete</b></center></div>
                            <div class="card-body" style="background-color:#e3f2fd;margin-top:20px;font-size:20px">
                               
                              <form class="needs-validation"  action="DeleteMiddleServlet" method="post" id="reg-form">
