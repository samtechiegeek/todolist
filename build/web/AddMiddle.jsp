<%-- 
    Document   : addfront
    Created on : 10-Dec-2020, 7:34:58 PM
    Author     : Windows
--%>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card" style="margin-top:30px;">
                            ...
                            <div class="card-body" style="background-color:#e3f2fd;margin-top:20px;font-size:20px">
                              ...
                              <form class="needs-validation"  action="AddMiddleServlet" method="post" id="reg-form">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="username" name="listlocation" placeholder="Enter the Location" required>
  </div>
  </div>
