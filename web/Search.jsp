<%-- 
    Document   : addlast
    Created on : 10-Dec-2020, 7:35:13 PM
    Author     : Windows
--%>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card" style="margin-top:30px;">
                            <div class="card-header" style="font-size:20px"><center><b>Enter the Number to Search</b></center></div>
                            <div class="card-body" style="background-color:#e3f2fd;margin-top:20px;font-size:20px">
                               
                              <form class="needs-validation"  action="SearchServlet" method="post" id="reg-form">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="username" name="listnumber" placeholder="Enter the list numbers" required>
                                  ...
                                  <center>  <button class="btn btn-primary" >Enter</button></center>
                              </form>
                            </div>
                                </div>
                    </div>
